...
class ItemProgressionBuilder:
    ...
    def get_progression_rules(condition_factory: ConditionFactory,
        ...
        for item_progression_item in item_progression:
            ...
            rules.append(rule_factory.get_rule(RuleType.SHOW, area_conditions + [base_type_condition, normal_condition, start_level_condition, end_level_condition], normal_style))
            rules.append(rule_factory.get_rule(RuleType.SHOW, area_conditions + [base_type_condition, magic_condition, start_level_condition, end_level_condition], magic_style))
            rules.append(rule_factory.get_rule(RuleType.SHOW, area_conditions + [base_type_condition, rare_condition, start_level_condition, end_level_condition], rare_style))
