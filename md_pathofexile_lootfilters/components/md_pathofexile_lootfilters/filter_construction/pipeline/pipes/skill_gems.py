...
class AddSkillGems(IPipe):
    ...
    def _get_rules(self, data: FilterConstructionPipelineContext) -> List[Rule]:
        ...
        rows = filter_rows_by_category(BaseTypeCategory.skill_gems, data.base_type_data)
        ...
        for row in cleaned.itertuples(index=False):
            rules.append(get_tier_currency_rule(self._rule_factory, self._condition_factory, row, tier_counts, data, BaseTypeCategory.skill_gems))
